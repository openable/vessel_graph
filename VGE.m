...
h = initGUI();
    ...
    function h = initGUI()
        ...
        h.list = uicontrol('Style','listbox', 'Parent',h.tab1, 'String',{}, ...
            ...
            'Position',[20 200 130 590], 'Callback',@onSelect); % 140
        ...
        h.labelEdit = uicontrol('Style','edit', 'Parent',h.tab1, 'String',{}, ...
            ...
            'Position',[60 170 60 20], 'KeyPressFcn',@onEditKey);
    ...
    function onAuto(~,~)
        msgbox('혈관 그래프 최상위 점(Root)을 왼쪽 클릭으로 선택하십시오.','안내');
        rootMode2D = 1;
    end
